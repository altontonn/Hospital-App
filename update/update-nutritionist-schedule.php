...
if(isset($_POST['update_data'])){
    ...
    $query = "UPDATE `nutritionist_schedule` SET `schedule_date`='$s_date', `schedule_day`='$s_day', `start_time`='$s_start', `end_time`='$s_end', `average_consulting_time`='$s_time' WHERE `id`='$id'";
