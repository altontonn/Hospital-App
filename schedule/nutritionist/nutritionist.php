...
$userid = "SELECT `Firstname`, `Lastname` FROM `nutritionist` WHERE `id`= '".$_SESSION["id"]."'";
...
<div class="container-fluid">
    <div class="row flex-nowrap">
            ...
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                <div class="modal-header">
                    <a href="" class="d-flex align-items-center pb-1 mb-md-0 me-md-auto text-white text-decoration-none">
                        <span class="fs-5 d-none d-sm-inline text-primary text-center">Nutritionist</span>
                    </a>
                </div>
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start pt-3" id="menu">
                    <li class="nav-item">
                        <a href="../../Dashboard/nutritionist-profile.php" class="nav-link px-0 align-middle">
                    ...
                    <li class="nav-item">
                        <a href="nutritionist.php" class="nav-link align-middle px-0">
                    ...
                    <li class="nav-item">
                        <a href="../../staff-appointments/nutritionist.php" class="nav-link px-0 align-middle">
        ...
        <div class="col py-3" style="padding-left: 15rem;">
            <h4 class="mb-4 text-gray-800">Nutritionist Schedule</h4>
        <!-- <span id="message"></span> -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="row">
                        <div class="col">
                            <h6 class="m-0 font-weight-bold text-primary">Nutritionist Schedule List</h6>
                        </div>
        ...
        <div class="modal" id="myModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="modal_title">Add Nutritionist Schedule Data</h4>
                    </div>
...
$(document).ready(function(){
    ...
    function deleteUser(deleteId){
            $.ajax({
                url:"../../delete/nutritionist-schedule.php",
                type: 'post',
                data:{
                    deleteSend: deleteId
                },
