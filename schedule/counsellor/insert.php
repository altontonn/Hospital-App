...
if(isset($_POST['userSend']) && isset($_POST['dateSend']) && isset($_POST['daySend']) && isset($_POST['startSend']) && isset($_POST['endSend']) && isset($_POST['consultSend'])){
    ...
    $query = "INSERT INTO `counsellor_schedule` (`user_id`, `schedule_date`, `schedule_day`, `start_time`, `end_time`, `average_consulting_time`) VALUES ('$userSend', '$dateSend', '$day', '$startSend', '$endSend', '$consultSend')";
