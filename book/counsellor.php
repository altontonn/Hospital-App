...
if(isset($_POST['email_data'])){
    ...
    foreach($_POST['email_data'] as $row){
        $query = "INSERT INTO `counsellor_appointment` VALUES ('', '".$row['user']."','".$row['counsellor']."', '".$row['contact']."', '".$row['date']."', '".$row['start']." - ".$row['end']."', '".$row['day']."')";
        ...
        $mail->isHTML(true);
        $mail->Subject = "Home Based Care / Counsellor Appointment";
