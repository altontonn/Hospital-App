...
<div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-3 max-vh-100" style="position: fixed;">
    ...
    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start pt-3" id="menu">
        ...
        <li class="nav-item">
            <a href="../schedule/caregiver/caregiver.php" class="nav-link align-middle px-0">
        ...
        <li class="nav-item">
            <a href="../signout/caregiver.php" class="nav-link px-0 align-middle">
                <i class="fs-4 bi bi-power" style="height: 2rem; width: 2rem; color:aliceblue;"></i><span class="ms-1 d-none d-sm-inline">Logout</span> </a>
        </li>
