...
$query1 = "SELECT * FROM `nutritionist_appointment`";
$result1 = mysqli_query($con, $query1);
// $row1 = mysqli_fetch_array($result1);

$query = "SELECT *  FROM `nutritionist_appointment`";
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            ?>
                                <input type="hidden" name="nutritionist_id" id="nutritionist_id" /> 
                                <tr>
        ...
        <div class="modal" id="dataModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="nutritionist_detail">  
                    </div>  
...
<script>
    $(document).ready(function(){
        $(document).on('click', '.view_button', function(){  
           var nutritionist_id = $(this).attr("id");  
           if(nutritionist_id != '')  
           {  
                $.ajax({  
                     url:"modal-nutritionist.php",  
                     method:"POST",  
                     data:{
                         nutritionist_id:nutritionist_id
                        },  
                     success:function(data){  
                          $('#nutritionist_detail').html(data);  
