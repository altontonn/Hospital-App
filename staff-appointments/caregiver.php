...
$query1 = "SELECT * FROM `caregiver_appointment`";
$result1 = mysqli_query($con, $query1);
// $row1 = mysqli_fetch_array($result1);

$query = "SELECT *  FROM `caregiver_appointment`";
...
<div class="container-fluid">
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 min-vh-100" style="background-color: #212529;">
            <?php include("../Admin/caregiver.php"); ?>
        </div>
        <div class="col py-3">
        ...
        <div class="modal" id="dataModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="caregiver_detail">  
                    </div>  
...
<script>
    $(document).ready(function(){
        $(document).on('click', '.view_button', function(){  
           var caregiver_id = $(this).attr("id");  
           if(caregiver_id != '')  
           {  
                $.ajax({  
                     url:"modal-caregiver.php",  
                     method:"POST",  
                     data:{caregiver_id:caregiver_id},  
                     success:function(data){  
                          $('#caregiver_detail').html(data);  
