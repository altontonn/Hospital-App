...
$query1 = "SELECT * FROM `counsellor_appointment`";
$result1 = mysqli_query($con, $query1);
// $row1 = mysqli_fetch_array($result1);

$query = "SELECT *  FROM `counsellor_appointment`";
...
<div class="container-fluid">
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 min-vh-100" style="background-color: #212529;">
            <?php include("../Admin/counsellor.php"); ?>
        </div>
        <div class="col py-3">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            ?>
                                <input type="hidden" name="counsellor_id" id="counsellor_id" /> 
                                <tr>
        ...
        <div class="modal" id="dataModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="counsellor_detail">  
                    </div>  
...
<script>
    $(document).ready(function(){
        $(document).on('click', '.view_button', function(){  
           var counsellor_id = $(this).attr("id");  
           if(counsellor_id != '')  
           {  
                $.ajax({  
                     url:"modal-counsellor.php",  
                     method:"POST",  
                     data:{
                         counsellor_id:counsellor_id
                        },  
                     success:function(data){  
                          $('#counsellor_detail').html(data);  
