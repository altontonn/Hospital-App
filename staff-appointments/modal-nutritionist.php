  ...
  <?php  
 if(isset($_POST["nutritionist_id"]))  
 {  
      $output = '';  
      $connect = mysqli_connect("localhost", "root", "", "home_based_care");  
      $query = "SELECT * FROM `nutritionist_appointment` WHERE `appointment_no` = '".$_POST["nutritionist_id"]."'";  
      ...
      $output .= '  
                ...
                <h4 class="text-center">nutritionist Details</h4>
            <table class="table">
                <tbody>
                    <tr>
                        <th style="width: 40%;"class="text-right">nutritionist Name: </th>
                        <td>'.$row["nutritionist_name"].'</td>
                    </tr>
                    <tr>
