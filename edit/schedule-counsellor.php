...
readfile("../index.html");
include("../update/update-counsellor-schedule.php");

session_start();
$id = $_GET['edit'];
$query = "SELECT * FROM `counsellor_schedule` WHERE `id` = '$id'";
...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <a href="../schedule/counsellor/counsellor.php" class="nav-link px-0 align-middle">
