...
readfile("../index.html");
include("../update/update-nutritionist-schedule.php");

session_start();
$id = $_GET['edit'];
$query = "SELECT * FROM `nutritionist_schedule` WHERE `id` = '$id'";
...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <a href="../schedule/nutritionist/nutritionist.php" class="nav-link px-0 align-middle">
