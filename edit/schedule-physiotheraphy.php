...
readfile("../index.html");
include("../update/update-physiotheraphy-schedule.php");

session_start();
$id = $_GET['edit'];
$query = "SELECT * FROM `physiotheraphy_schedule` WHERE `id` = '$id'";
...
<div class="container-fluid">
    <div class="row flex-nowrap">
                ...
                <div class="col">
                    <div class="form-group p-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control" id="schedule-date" name="schedule-date" value="<?php echo $row["schedule_date"] ?>">
                        </div>
                    </div>
                    <div class="form-group p-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="weekdays" class="form-control" id="schedule-day" name="schedule-day" value="<?php echo  $row["schedule_day"]?>">
                        </div>
                    </div>
                    <div class="form-group p-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                            <input type="time" class="form-control" id="start-time" name="start-time" value="<?php echo  $row["start_time"] ?>">
                        </div>
                    </div>
                    <div class="form-group p-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text"><i class="fas fa-clock"></i></span>
                            <input type="time" class="form-control" id="end-time" name="end-time" value="<?php echo  $row["end_time"] ?>">
                        </div>
                    </div>
                    <div class="form-group p-3">
        ...
        <a href="../schedule/physiotheraphy/physiotheraphy.php" class="nav-link px-0 align-middle">
