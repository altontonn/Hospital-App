        ...
        <?php endif ?>
            <table class="table table-responsive">
                ...
                <tbody>
                    ...
                    <td><a class="btn btn-primary text-white" href="../edit/nutritionist.php?edit=<?php echo $row['id']?>">Edit</a></td>
                    <td><a class="btn btn-danger text-white" href="../delete/nutritionist.php?delete=<?php echo $row['id']?>">Delete</a></td>
                    </tr>
                </tbody>
                <?php 
                $i++;
