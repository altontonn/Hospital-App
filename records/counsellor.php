        ...
        <?php endif ?>
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <td><a class="btn btn-primary text-white" href="../edit/counsellor.php?edit=<?php echo $row['id']?>">Edit</a></td>
                    <td><a class="btn btn-danger text-white" href="../delete/counsellor.php?delete=<?php echo $row['id']?>">Delete</a></td>
                    </tr>
                </tbody>
                <?php 
                $i++;
